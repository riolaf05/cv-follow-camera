...
# implementation)
image = cv2.imread(args["image"]) #get image from inputs
(h, w) = image.shape[:2] #extract the height and width
blob = cv2.dnn.blobFromImage(cv2.resize(image, (300, 300)), 0.007843,(300, 300), 127.5) #calculate a 300 by 300 pixel blob  from our image
