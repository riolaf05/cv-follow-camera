...
class StreamingHandler(server.BaseHTTPRequestHandler):
    ...
    def append_objs_to_img(self, cv2_im, objs, labels):
        ...
        for obj in objs:
            ...
            if labels[obj.label_id] == 'person': #os.getenv('OBJECT'): #and percent > 70:
                angle=translate((x0+x1)/2, 1, 800, 45, 135)
                #print(labels[obj.label_id], 'point: ', (x0+x1)/2, ', angle', angle)
                move_servo(angle)
...
if __name__ == '__main__':
    ...
    with picamera.PiCamera(resolution=res, framerate=FRAMERATE, sensor_mode=2) as camera:
        ...
        try:
            ...
            print("error on the server!")import os
import io
import time
import base64
import argparse
